...
const EDITOR_COPY = {
  ja: {
    ...
    copySelection: 'コピー',
    copiedSelection: '選択したオブジェクトをコピーしました',
    invalidImageFile: '画像ファイルを選択してください。',
    tableDialogTitle: '表を追加',
    tableNameLabel: '名前',
    tableNamePlaceholder: '表の名前',
    rowLabel: '行',
    columnLabel: '列',
    insertTable: '表を挿入',
    tableSizeError: '行と列は1〜20の範囲で指定してください。',
    chartDialogTitle: 'グラフを追加',
    chartTitleLabel: 'タイトル',
    chartLabelsLabel: 'ラベル',
    chartValuesLabel: '値',
    chartLabelsPlaceholder: 'Q1, Q2, Q3, Q4',
    chartValuesPlaceholder: '120, 180, 150, 240',
    insertChart: 'グラフを挿入',
    chartValuesError: 'カンマ区切りで数値を入力してください。',
    linkLabel: 'リンク',
    linkDialogTitle: 'リンクを追加',
    linkUrlLabel: 'URL',
    linkUrlPlaceholder: 'https://example.com',
    applyLink: '適用',
    removeLink: '削除',
    invalidLink: '有効なURLを入力してください。',
    underlineColorLabel: '下線の色',
    previewPrevious: '前へ',
    previewNext: '次へ',
    quizDialogTitle: 'クイズ',
    quizQuestionLabel: '問題',
    quizAnswerLabel: '回答',
    closeQuiz: '閉じる',
    quizBuilderTitle: 'クイズを作成',
    quizTypeLabel: '問題タイプ',
    quizTypeChoice: '選択式',
    quizTypeWritten: '記述式',
    quizQuestionPlaceholder: '問題を入力',
    quizHintLabel: 'ヒント',
    quizHintPlaceholder: 'ヒント（任意）',
    quizOptionPlaceholder: '選択肢 {{letter}}',
    quizCorrectLabel: '正解',
    quizAddOption: '選択肢を追加',
    quizOptionLimit: '選択肢は最大4つです。',
    quizSaveQuestion: '問題を保存',
    quizUpdateQuestion: '問題を更新',
    quizOverviewTitle: 'クイズ概要',
    quizQuestionCount: '問題数: {{count}}',
    quizQuestionListTitle: '問題一覧',
    quizColumnNumber: 'No.',
    quizColumnQuestion: '問題',
    quizColumnType: 'タイプ',
    quizColumnAction: '操作',
    quizEditQuestion: '編集',
    quizDeleteQuestion: '削除',
    quizFinish: 'クイズを完了',
    quizBack: '戻る',
    quizNoQuestions: 'まだ問題がありません。',
    quizValidationQuestion: '問題を入力してください。',
    quizValidationChoice: '少なくとも2つの選択肢を入力してください。',
    quizValidationAnswer: '回答を入力してください。',
    quizInserted: '{{count}}枚のクイズスライドを挿入しました',
    quizFinishing: 'クイズを保存中...',
    quizSlideTitle: 'クイズ',
    quizTargetSlidePreview: '対象スライドのプレビュー',
    quizCheckAnswer: '答えを確認',
    quizCorrectFeedback: '正解',
    quizWrongFeedback: '不正解',
  },
  vi: {
    backShort: 'Trang chủ',
    toolText: 'Văn bản',
